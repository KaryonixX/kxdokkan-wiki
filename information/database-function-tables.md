...
| 62 | isAttackerElementTypeBitPattern | Activates if attacker has a specific element type bitset (?)| Unknown | Unknown | Unknown |
...
| 80 | Change Counter Attack                                                                                                     | Damage Reduction(%)(Optional)              | Counter Multiplier                | Lua Script # From Folder [lua] > [ab_script] > [attack_counter] > cXXXX.lua (the number you put is whatever is in XXXX, excluding the first 2 or zeroes before the number) |      | |
...
| 114| AttackImpossible                                                                                                          |                                            |                                   |                                            | {"text":"Put text here","script_path":"lua/ab_script/ab_sys/cannot_attack.lua"}  |                                            |
...
| 120| Counter Attack Behaviour                                                                                                  | Same as eff 80                             | Same as eff 80                    | Same as eff 80                             |                                         |                                                                                     |
| 121| Unknown                                                                                                                   |                                            |                                   |                                            |                                         |                                                                                     |
